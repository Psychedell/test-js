...
import onBtnWatchedClick from "./watch-queue";
...
function createModal() {
  const markup = `
    <div class="backdrop">
      <div class="film-card modal" data-id=${respData.id}>
        ...
        <div>
          ...
          <div class="film-card__features">
            ...
            <ul>
              <li class="film-card__feature-description"><span class="vote">${respData.vote_average.toFixed(
                1
              )}</span> <span
                                class="divider"> / </span> ${
                                  respData.vote_count
                                }</li>
              <li class="film-card__feature-description">${respData.popularity.toFixed(
                1
              )}</li>
              <li class="film-card__feature-description original-title">${
